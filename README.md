...
**Kurzbeschreibung:**
Steuere deine Rakete vom Boden bis in den Weltraum!

**Vollständige Beschreibung:**

🚀 ROCKET RISE – Fliege höher als je zuvor!

Starte deine Rakete vom Boden und fliege durch die Atmosphäre
bis in den Weltraum! Sammle Coins, kaufe Upgrades und erreiche
immer größere Höhen.

🎮 GAMEPLAY
- Manuelle Steuerung: Gas & Lenkung per Touch
- Physik-basierter Flug mit Schwerkraft & Luftwiderstand
- 4 Zonen: Troposphäre → Atmosphäre → Stratosphäre → Weltraum

⚡ POWERUPS · ⛽ Treibstoff · 🧲 Coin-Magnet · 🛡️ Schild

🛒 UPGRADES · 12 Upgrades in 5 Kategorien, je 5 Stufen

🏆 FEATURES · Meilensteine · Tägliches Streak-System · Highscore

Wie hoch kannst du fliegen? 🌌

**Keywords:**
Rakete, Rocket, Weltraum, Space, Flugspiel, Arcade, Upgrades, Casual Game, Physik, Endlos

**Datenschutz-URL:**
https://vleyhausen-source.github.io/rocket-app/privacy-policy.html

> Vollständige Store-Listing-Datei: [`assets/store-listing.md`](assets/store-listing.md)
